// src/components/event/EditEventModal.jsx
...
// simple client id for list keys (no crypto dependency)
...
export default function EditEventModal({ open, onOpenChange, event }) {
  const { updateEvent, state } = useEvents();
  ...
  // track original slug to only check uniqueness when changed
  const originalSlugRef = useRef("");

  // guard state updates after modal closes fast
  ...
  // Prefill from event on open/change
  useEffect(() => {
    if (!event) return;
  ...
  // title + slug behavior (similar to create)
  ...
  function toNumberOrZero(v) {
    ...
    // keep as 0 for "unlimited" when empty string later
  }
  ...
  async function handleSubmit(e) {
    ...
    // block while slug-check unresolved/invalid/taken (only if changed)
    const slugChanged =
    ...
    if (slugChanged) {
      ...
      if (slugStatus === "taken") {
        setErrors((p) => ({
          ...p,
          slug: "Slug already in use. Try a different one (e.g., add -2026 or -hamburg).",
        }));
        setSubmitting(false);
        return;
      }
    ...
    // 1) coerce numeric fields just for validation/diff
    const toValidate = {
      ...formData,
      capacity: toNumberOrZero(
        formData.capacity === "" ? 0 : formData.capacity
      ),
    };
    ...
    // 2) Build patch by diffing current form schema vs baseline event schema
    const baseline = schemaFromEvent(event);

    const cleanSpeakers = (formData.speakers || []).map(
      ({ __cid, ...rest }) => rest
    );
    const cleanAgenda = (formData.agenda || []).map(
      ({ __cid, ...rest }) => rest
    );
    ...
    const current = buildSchemaFromForm({
      ...
      agenda: cleanAgenda,
      // send as numbers where appropriate
      capacity: toNumberOrZero(
        formData.capacity === "" ? 0 : formData.capacity
      ),
      venueLatitude:
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  disabled={
                    submitting || state.updating || formData.__uploadingCover
                  }
                />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateFormData("venueCountry", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateFormData("venueLatitude", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateFormData("venueLongitude", e.target.value)
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {!autoMap &&
                      mapCandidate &&
                      mapCandidate !== formData.mapEmbedUrl && (
                        <Button
                          type="button"
                          variant="outline"
                          size="sm"
                          onClick={() =>
                            updateFormData("mapEmbedUrl", mapCandidate)
                          }
                        >
                          Use suggested map
                        </Button>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateFormData("organizerWebsite", e.target.value)
                  }
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    updateFormData("organizerBio", e.target.value)
                  }
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateFormData("organizerAvatar", e.target.value)
                  }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateFormData("organizerTwitter", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateFormData("organizerLinkedIn", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateFormData("organizerGitHub", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateFormData("organizerWebsiteUrl", e.target.value)
                    }
                  />
                </div>
              </div>
                ...
                <Card className="mt-4">
                  ...
                  <CardContent className="space-y-4">
                    {formData.speakers.map((sp) => {
                      const idKey = sp._id || sp.id || sp.__cid; // stable key + id
                          ...
                          <CardContent className="pt-6 space-y-4">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                              <div>
                                ...
                                <Input
                                  value={sp.name || ""}
                                  onChange={(e) =>
                                    updateSpeaker(idKey, "name", e.target.value)
                                  }
                                />
                              </div>
                              <div>
                            ...
                            <div>
                              ...
                              <Textarea
                                value={sp.bio || ""}
                                onChange={(e) =>
                                  updateSpeaker(idKey, "bio", e.target.value)
                                }
                              />
                            </div>
                          </CardContent>
                            ...
                            <div className="space-y-4">
                              <div>
                                ...
                                <Input
                                  ...
                                  value={session.title || ""}
                                  onChange={(e) =>
                                    updateSession(key, "title", e.target.value)
                                  }
                                />
                              </div>
                              <div>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                  ...
                                  <Input
                                    ...
                                    value={session.room || ""}
                                    onChange={(e) =>
                                      updateSession(key, "room", e.target.value)
                                    }
                                  />
                                </div>
                                <div>
