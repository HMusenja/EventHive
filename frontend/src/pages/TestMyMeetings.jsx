...
export default function Meetings() {
    ...
    // —— mock data kept locally so Cancel/Edit can affect UI
    const [meetings, setMeetings] = useState([
        ...
        },
        {
            ...
            attendees: [{ name: "Emily Rodriguez", avatar: "/placeholder-avatar-3.jpg", role: "UX Designer" }],
            date: "2024-01-16",
            time: "2:00 PM",
            duration: "30 min",
            type: "in-person",
        ...
        },
        {
            ...
            attendees: [{ name: "Sarah Johnson", avatar: "/placeholder-avatar-1.jpg", role: "Product Manager" }],
            date: "2024-01-18",
            time: "11:00 AM",
            duration: "45 min",
            type: "video",
        ...
        {
            id: 6,
            title: "MeetUp - Talk Talk Talk",
            attendees: [
                { name: "Ivan Chen", avatar: "/placeholder-avatar-2.jpg", role: "Developer" },
                { name: "Martin Gore", avatar: "/placeholder-avatar-6.jpg", role: "Engineering Manager" },
            ],
            date: "2025-09-18",
            time: "5:00 PM",
            duration: "120 min",
            ...
            status: "pending",
            description: "Face the future trends.",
        },
    ]);
    ...
    const getTypeIcon = (type) =>
        type === "video" ? <Video className="h-4 w-4" /> : <MapPin className="h-4 w-4" />;
    ...
    // Calendar (uses the same 'meetings' state)
    const CalendarView = () => {
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            const hasMeetings = meetings.some((m) => m.date === dateStr);

            days.push(
                <div
                    key={day}
                    className={`h-12 p-1 border rounded cursor-pointer hover:bg-muted/50 ${hasMeetings ? "bg-primary/10 border-primary/20" : "border-border"
                        }`}
                >
                    <div className="text-sm font-medium">{day}</div>
                    {hasMeetings && <div className="w-2 h-2 bg-primary rounded-full mt-1" />}
                </div>
            );
        }
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-muted-foreground">Manage your upcoming meetings and schedule new ones</p>
                </div>
                                ...
                                <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-2 lg:flex-col lg:w-32">
                                        {meeting.status === "confirmed" && meeting.meetingLink && (
                                            <Button asChild className="bg-gradient-to-r from-primary to-secondary" size="sm">
                                                <a href={meeting.meetingLink} target="_blank" rel="noreferrer">Join Meeting</a>
                                            </Button>
                                        )}

                                        {/* Edit → navigate to people to (re)schedule */}
                                        <Button asChild variant="outline" size="sm">
                                            <Link to={scheduleTo}>Edit</Link>
                                        </Button>

                                        {/* Cancel (local state change for mock) */}
                                        <Button
                                            variant="outline"
                                            size="sm"
